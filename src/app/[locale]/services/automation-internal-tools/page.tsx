    ...
    <main className="flex-1 -mt-28 overflow-x-hidden pt-28 relative">
      <JsonLd
        schema={serviceSchema({
          locale,
          path: "/services/automation-internal-tools",
          name: "Internal Tools & Process Automation",
          description: "Custom dashboards, admin panels, and back-office automation for operations teams.",
      ...
      <RelatedGuides
        locale={locale}
        slugs={SERVICE_CLUSTERS["automation-internal-tools"]}
      />
    </main>
  );
}

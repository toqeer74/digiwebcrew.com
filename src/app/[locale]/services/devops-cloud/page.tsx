        ...
        <div className="max-w-6xl mx-auto space-y-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <AnimatedSection className="md:col-span-8 site-card p-10 relative overflow-hidden">
              ...
              <h2 className="text-3xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-6 tracking-tight">System Resilience</h2>
              <p className="text-slate-600 dark:text-[#94A3B8] text-lg leading-relaxed mb-8">
            ...
            <AnimatedSection className="md:col-span-4 site-card p-10 relative overflow-hidden bg-slate-950 text-white flex flex-col justify-center">
              <h3 className="text-xl font-display font-black mb-6 text-emerald-400">Security & Ops</h3>
            ...
            <AnimatedSection className="md:col-span-12 site-card p-10 lg:p-12 relative overflow-hidden">
               ...
               <h3 className="text-2xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-8">Infrastructure Stack</h3>
               <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                 {techStack.map(t => (
                   <div key={t} className="p-4 rounded-xl border border-slate-200 dark:border-white/10 text-center font-bold text-slate-600 dark:text-[#94A3B8] bg-slate-50 dark:bg-white/5 uppercase tracking-widest text-[10px]">
                     {t}
                   </div>
                 ))}
               </div>

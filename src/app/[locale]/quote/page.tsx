      ...
      <Container>
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            <AnimatedSection className={cn(sectionCardClass, "md:col-span-12 lg:col-span-8")}>
              ...
              <h2 className="text-3xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-6 tracking-tight">A Better Way to Start When the Project Needs More Definition</h2>
            ...
            <div className="md:col-span-12 lg:col-span-4 space-y-8">
              <AnimatedSection className={cn(sectionCardClass, "h-full")}>
                ...
                <h2 className="text-2xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-6">When This Is Better</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <AnimatedSection className={sectionCardClass}>
              ...
              <h2 className="text-2xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-6">What We Need to Learn From the Scope</h2>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                {scopeNeeds.map((item) => (
                  <li key={item} className="flex items-center gap-3 text-sm text-slate-600 dark:text-[#94A3B8]">
            ...
            <AnimatedSection className={sectionCardClass}>
              ...
              <h2 className="text-2xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-6">How It Works</h2>
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex gap-4 p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-900 dark:text-[#F8F8FF] text-sm">{item.title}</h4>
                      <p className="text-xs text-slate-500 dark:text-[#94A3B8]">{item.text}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div id="scope-form" className="mt-24">
          <AnimatedSection className={cn(sectionCardClass, "mb-12 text-center max-w-4xl mx-auto")}>
            {gradientTop}
            <h2 className="text-3xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-4">Tell Us About the Project</h2>
        ...
        <div className="max-w-6xl mx-auto space-y-12 mt-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <AnimatedSection className={sectionCardClass}>
              {gradientTop}
              <h2 className="text-2xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-4">Why This Is a Strong Conversion Path</h2>
            ...
            <AnimatedSection className={sectionCardClass}>
              {gradientTop}
              <h2 className="text-2xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-6">Who This Is Best For</h2>
          ...
          <AnimatedSection className={cn(sectionCardClass, "text-center bg-slate-50 dark:bg-[#0A0A0F] border-2 border-[var(--site-primary)]/10")}>
            {gradientTop}
            <h2 className="text-3xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-6">Questions About the Project Scope Process</h2>
          ...
          <AnimatedSection className="site-card overflow-hidden relative text-center p-12 lg:p-16 border-2 border-[var(--site-primary)]/20 shadow-[0_40px_80px_-40px_rgba(var(--site-primary-rgb),0.3)]">
            {gradientTop}
            <h2 className="text-3xl md:text-5xl font-display font-black text-slate-950 dark:text-[#F8F8FF] mb-6 tracking-tight">Ready to Define the Right Project Scope?</h2>

      ...
      <Container>
        <div className="max-w-5xl mx-auto space-y-8 mb-10">
          <AnimatedSection className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#scope-form" className="inline-flex items-center justify-center gap-3 rounded-full bg-[#6366F1] px-8 py-4 text-white font-bold shadow-[0_26px_60px_-36px_rgba(99,102,241,0.4)] transition-all duration-300 hover:bg-[#6366F1]/90">
              ...
              <Link href={localePath(locale, "/book-consultation")} className="inline-flex items-center justify-center gap-3 rounded-full border border-[#1E1E2E] bg-[#13131E] text-[#F8F8FF] font-bold px-8 py-4 shadow-[0_26px_60px_-36px_rgba(0,0,0,0.5)] transition-all duration-300 hover:bg-[#1a1a2e]">
        ...
        <div className="max-w-5xl mx-auto space-y-8 mt-10">
          ...
          <AnimatedSection className="bg-[#13131E] border border-[#1E1E2E] rounded-xl p-8">
            ...
            <Link href={localePath(locale, "/book-consultation")} className="inline-flex items-center justify-center gap-3 rounded-full bg-[#6366F1] px-6 py-3 font-bold text-white shadow-[0_26px_60px_-36px_rgba(99,102,241,0.4)] transition-all duration-300 hover:bg-[#6366F1]/90">
              <span>Book Consultation</span>
          ...
          <AnimatedSection className="bg-[#13131E] border border-[#1E1E2E] rounded-xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href={localePath(locale, "/book-consultation")} className="inline-flex items-center justify-center gap-3 rounded-full border border-[#1E1E2E] bg-[#0F0F18] text-[#F8F8FF] font-bold px-8 py-4 shadow-[0_26px_60px_-36px_rgba(0,0,0,0.5)] transition-all duration-300 hover:bg-white/5">
                <span>Book Consultation</span>
                <span className="grid h-8 w-8 place-items-center rounded-full bg-white/5 ring-1 ring-white/10">
                  <ArrowRight className="h-4 w-4" aria-hidden="true" />
                </span>

  ...
  return (
    <div className="admin-page-stack w-full pb-8">
      <PageHeader
        ...
        breadcrumb={[{label:"Dashboard",href:"/digiadmin/dashboard"},{label:"AI Assistant"}]}
      />
            ...
            {!loading && library?.success && (
              <>
                ...
                {draftId && <div className="rounded-xl p-3 flex items-center gap-2" style={{background:"var(--adm-success-dim)",border:"1.5px solid #6ee7b7",color:"#065f46",fontSize:13}}>
                  <CheckCircle size={14}/> Draft saved. <Link href={`/digiadmin/drafts/${draftId}`} className="font-semibold underline inline-flex items-center gap-1">Open<ExternalLink size={11}/></Link>
                </div>}
              ...
              <>
                ...
                {workflowRunId && <>
                  <div className="rounded-xl p-3 flex items-center gap-2" style={{background:"var(--adm-success-dim)",border:"1.5px solid #6ee7b7",color:"#065f46",fontSize:13}}>
                    <CheckCircle size={14}/> Run created. <Link href={`/digiadmin/workflow-runs/${workflowRunId}`} className="font-semibold underline">View run</Link>
                  </div>

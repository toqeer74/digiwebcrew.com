        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
          ...
          <ACard>
            <ACardHeader>
              ...
              <Link href="/digiadmin/leads" className="adm-btn adm-btn-ghost adm-btn-sm inline-flex items-center gap-1">
                  ...
                  <tbody>
                    {(data.recentLeads || []).map((lead: any) => (
                      <tr key={lead.id || lead.name}>
                        <td>
                          <Link href={`/digiadmin/leads/${lead.id}`} style={{ fontWeight: 600, color: "var(--adm-primary)" }}>{lead.name}</Link>

  ...
  return (
    <div className="admin-page-stack w-full pb-8">
      <PageHeader
        ...
        breadcrumb={[{ label: "Dashboard", href: "/digiadmin/dashboard" }, { label: "Workflow Runs" }]}
      />
            ...
            return (
              <div key={run._id} className="adm-run-row">
                ...
                <div style={{ display: "flex", gap: 8, alignItems: "center", flexShrink: 0 }}>
                  ...
                  {grouped.length > 0 ? (
                    <Link href={`/digiadmin/workflow-runs/${run._id}`} className="adm-btn adm-btn-secondary adm-btn-sm">Details</Link>
                  ) : (

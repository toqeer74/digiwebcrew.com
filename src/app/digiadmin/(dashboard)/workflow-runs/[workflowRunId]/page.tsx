...
export default async function WorkflowRunDetailPage({
  ...
  if (drafts.length === 0) redirect("/digiadmin/workflow-runs");
    ...
    <div className="admin-page-stack w-full pb-8">
      <PageHeader
        ...
        breadcrumb={[
          ...
          { label: "Workflow Runs", href: "/digiadmin/workflow-runs" },
          { label: "Detail" },
        ]}
        actions={
          <Link href="/digiadmin/workflow-runs" className="adm-btn adm-btn-secondary adm-btn-sm inline-flex items-center gap-2">
                ...
                return (
                  <tr key={id}>
                    ...
                    <td style={{ textAlign: "right" }}>
                      <Link href={`/digiadmin/drafts/${id}`} className="adm-btn adm-btn-secondary adm-btn-sm">
                        View Draft
                      </Link>
                    </td>
                  </tr>
